...
namespace JSON_DB
{
    public sealed class PhoneRepository : IRepository<Phone>
    {
        ...
        public void SaveModel()
        {
            ...
            File.WriteAllText(@"D:\BSTU\PIS-3c6s\LR6\JSON_DB\PhonesDB.json", json);
        }

        public void LoadModel()
        {
            Phones = JsonSerializer.Deserialize<List<Phone>>(File.ReadAllText(@"D:\BSTU\PIS-3c6s\LR6\JSON_DB\PhonesDB.json"));
        }
